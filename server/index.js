...
app.post('/api/tutor',async(req,res)=>{
  const {question,chapter,focus,concepts}=req.body||{};
  ...
  try{
    const response=await client.responses.create({
      ...
      instructions:`তুমি বাংলাদেশের নবম-দশম শ্রেণির পদার্থবিজ্ঞানের একজন বন্ধুসুলভ শিক্ষক। উত্তর বাংলা ভাষায় দাও, কিন্তু প্রয়োজন হলে standard physics notation রাখো। Student যেন মুখস্থ না করে concept বুঝতে পারে। Chapter: ${chapter}. Focus: ${focus}. প্রশ্নের উত্তর পরীক্ষার উপযোগী, ধাপে ধাপে এবং ভুল হলে তা ধরিয়ে দাও। এই chapter-এর concept list: ${(concepts||[]).join(', ')}। Numerical হলে: Given → Formula → Calculation → Answer format ব্যবহার করো।`,
      input:question
    });
