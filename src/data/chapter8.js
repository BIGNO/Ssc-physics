export const chapter8 = {
  ...
  manual: [
    ...
    "Lateral inversion ব্যাখ্যা করতে পারা",
    "Spherical mirror-এর ধারণা বুঝতে পারা",
    "Concave ও convex mirror-এর পার্থক্য জানা",
    "Pole, principal axis ও aperture চিহ্নিত করতে পারা",
    "Centre of curvature ও radius of curvature বুঝতে পারা",
    "Principal focus ও focal length বুঝতে পারা",
    "F এবং C-এর সম্পর্ক ব্যাখ্যা করতে পারা",
    "Concave mirror-এর ray diagram আঁকতে পারা",
    "Convex mirror-এর ray diagram আঁকতে পারা",
    "Object position অনুযায়ী image formation নির্ণয় করতে পারা",
    "Real ও virtual image-এর অবস্থান ও বৈশিষ্ট্য নির্ণয় করতে পারা",
    "Mirror formula ব্যবহার করতে পারা",
    "Magnification-এর formula ব্যবহার করতে পারা",
    "Cartesian sign convention প্রয়োগ করতে পারা",
    "Mirror numerical problem ধাপে ধাপে সমাধান করতে পারা",
    "Plane, concave ও convex mirror-এর ব্যবহার ব্যাখ্যা করতে পারা"
  ],
  ...
  concepts: [

    {
      ...
      detailedExplanation: "যখন আলোকরশ্মি কোনো polished বা reflecting surface-এ আপতিত হয়ে একই মাধ্যমে ফিরে আসে, তখন তাকে আলোর প্রতিফলন বলে। Reflection-এর ক্ষেত্রে incident ray, reflected ray এবং normal-এর পারস্পরিক সম্পর্ক দুটি সূত্র দ্বারা নির্ধারিত হয়।",
      formula: "∠i = ∠r",
      units: "Angle → degree (°)",
...

    {
      ...
      detailedExplanation: "Plane mirror-এ সাধারণত virtual, erect এবং laterally inverted image তৈরি হয়। Image-এর size object-এর সমান হয় এবং image mirror-এর পিছনে object-এর সমান দূরত্বে অবস্থান করে। Lateral inversion-এর কারণে ডান-বাম দিকের আপাত পরিবর্তন দেখা যায়।",
...

    {
      ...
      detailedExplanation: "Concave mirror একটি converging mirror। Principal axis-এর সমান্তরাল rays reflection-এর পর principal focus-এর দিকে converge করে। Object-এর অবস্থান C, F বা P-এর তুলনায় পরিবর্তন করলে image-এর position, size এবং nature পরিবর্তিত হয়।",
      formula: "1/f = 1/v + 1/u",
      units: "m বা cm",
...

    {
      ...
      detailedExplanation: "Convex mirror একটি diverging mirror। Principal axis-এর সমান্তরাল rays reflection-এর পর এমনভাবে diverge করে যেন তারা mirror-এর পিছনের principal focus থেকে এসেছে। তাই এটি সবসময় virtual, erect এবং diminished image তৈরি করে এবং wide field of view দেয়।",
      formula: "1/f = 1/v + 1/u",
      units: "m বা cm",
...

    {
      ...
      detailedExplanation: "Spherical mirror-এর numerical সমাধানে Cartesian sign convention অত্যন্ত গুরুত্বপূর্ণ। প্রথমে u, v ও f-এর sign নির্ধারণ করতে হয়, তারপর 1/f = 1/v + 1/u ব্যবহার করে অজানা রাশি বের করতে হয়। সব distance একই unit-এ রাখতে হবে।",
      formula: "1/f = 1/v + 1/u",
      units: "m বা cm",
...

    {
      ...
      detailedExplanation: "Mirror-এর ক্ষেত্রে magnification image-এর height এবং object-এর height-এর অনুপাত। Cartesian sign convention ব্যবহার করলে m = hᵢ/hₒ = -v/u। m-এর মান থেকে image বড় বা ছোট এবং sign থেকে image-এর orientation সম্পর্কে ধারণা পাওয়া যায়।",
      formula: "m = hᵢ/hₒ = -v/u",
      units: "কোনো একক নেই",
  ...
  formulaSheet: [
    "Reflection: ∠i = ∠r",
    "Plane mirror: Object distance = Image distance",
    ...
    "m = 1 → image same size",
    "Angle of incidence ও reflection normal-এর সাথে মাপতে হয়"
  ],
