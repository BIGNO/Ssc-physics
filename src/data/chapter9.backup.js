export const chapter9 = {
  ...
  manual: [
    ...
    'প্রতিসরণের সূত্র এবং Snell-এর সূত্র জানতে হবে',
    'প্রতিসরণাঙ্কের ধারণা ও সূত্র বুঝতে হবে',
    'ঘন ও লঘু মাধ্যমের মধ্যে আলোর গতির পরিবর্তন বুঝতে হবে',
    'কাচের স্ল্যাবের মধ্য দিয়ে আলোর পথ ব্যাখ্যা করতে হবে',
    'পার্শ্ব সরণ (lateral displacement) বুঝতে হবে',
    'দৃশ্যমান গভীরতা (apparent depth) ব্যাখ্যা করতে হবে',
    'সংকট কোণ ও পূর্ণ অভ্যন্তরীণ প্রতিফলন বুঝতে হবে',
    'Optical fibre ও মরীচিকা (mirage)-এর মতো বাস্তব প্রয়োগ জানতে হবে'
  ],
  ...
  concepts: [
    {
      ...
      detailedExplanation: 'বিভিন্ন মাধ্যমে আলোর বেগ ভিন্ন। তাই আলো যখন এক মাধ্যম থেকে অন্য মাধ্যমে তির্যকভাবে প্রবেশ করে, তখন তার বেগ পরিবর্তিত হয় এবং গতিপথও পরিবর্তিত হয়।',
...

    {
      ...
      detailedExplanation: 'প্রথম সূত্র অনুযায়ী আপতিত রশ্মি, প্রতিসরিত রশ্মি এবং অভিলম্ব একই সমতলে থাকে। দ্বিতীয় সূত্র অনুযায়ী নির্দিষ্ট দুটি মাধ্যমের জন্য sin i/sin r একটি ধ্রুবক।',
...

    {
      ...
      detailedExplanation: 'প্রতিসরণাঙ্ক সাধারণত μ বা n দ্বারা প্রকাশ করা হয়। এর মান যত বেশি, মাধ্যমটিতে আলোর বেগ সাধারণত তত কম।',
      formula: 'n = c/v',
      units: 'কোনো একক নেই',
...

    {
      ...
      detailedExplanation: 'সমান্তরাল পৃষ্ঠের কারণে emergent ray সাধারণত incident ray-এর সমান্তরাল হয়, তবে কিছুটা পার্শ্ব সরণ ঘটে।',
...

    {
      ...
      detailedExplanation: 'Critical angle কেবল denser medium থেকে rarer medium-এ যাওয়ার ক্ষেত্রে প্রাসঙ্গিক।',
...

    {
      ...
      detailedExplanation: 'TIR-এর দুটি শর্ত হলো: (১) আলোকে optically denser medium থেকে rarer medium-এ যেতে হবে এবং (২) আপতন কোণ critical angle-এর চেয়ে বেশি হতে হবে।',
      formula: 'i > C',
      units: 'কোণ ডিগ্রিতে',
...

    {
      ...
      detailedExplanation: 'Optical fibre সাধারণত core ও cladding নিয়ে গঠিত। Core-এর refractive index cladding-এর চেয়ে বেশি হওয়ায় উপযুক্ত angle-এ আলো TIR করতে করতে এগিয়ে যায়।',
