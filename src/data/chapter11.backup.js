export const chapter11 = {
  ...
  manual: [
    'তড়িৎ প্রবাহ কী এবং এর দিক বুঝতে হবে',
    'তড়িৎ প্রবাহের সূত্র ও SI একক জানতে হবে',
    'বিভব পার্থক্যের ধারণা বুঝতে হবে',
    'রোধ ও রোধের ওপর নির্ভরশীল বিষয়গুলো জানতে হবে',
    'Ohm-এর সূত্র ব্যাখ্যা করতে হবে',
    'V-I graph বুঝতে ও আঁকতে হবে',
    'Series ও parallel connection-এর পার্থক্য জানতে হবে',
    'Equivalent resistance নির্ণয় করতে হবে',
    'বিদ্যুৎ শক্তি ও বৈদ্যুতিক ক্ষমতার সূত্র ব্যবহার করতে হবে',
    'Electrical energy-এর commercial unit kWh বুঝতে হবে',
    'Fuse, circuit protection এবং দৈনন্দিন electrical safety সম্পর্কে জানতে হবে'
  ],
  ...
  concepts: [
    {
      ...
      detailedExplanation: 'কোনো পরিবাহকের একটি cross-section দিয়ে সময় t-তে Q charge প্রবাহিত হলে current I = Q/t। প্রচলিত current-এর দিক positive charge-এর গতির দিক হিসেবে ধরা হয়।',
      formula: 'I = Q/t',
      units: 'অ্যাম্পিয়ার (A)',
...

    {
      ...
      detailedExplanation: 'ধাতব পরিবাহকে electron বিপরীত দিকে চললেও circuit analysis-এ conventional current-এর দিক positive terminal থেকে negative terminal-এর দিকে ধরা হয়।',
...

    {
      ...
      detailedExplanation: 'দুটি বিন্দুর potential-এর পার্থক্য electrical circuit-এ current flow-এর জন্য প্রয়োজনীয় driving force তৈরি করে।',
      formula: 'V = W/Q',
      units: 'ভোল্ট (V)',
...

    {
      ...
      detailedExplanation: 'রোধকে R দ্বারা প্রকাশ করা হয়। একই voltage-এ resistance বাড়লে current সাধারণত কমে যায়।',
      formula: 'R = V/I',
      units: 'ওহম (Ω)',
...

    {
      ...
      detailedExplanation: 'তারটির রোধ R = ρL/A। একই material ও temperature-এ দৈর্ঘ্য বাড়লে resistance বাড়ে এবং cross-sectional area বাড়লে resistance কমে।',
      formula: 'R = ρL/A',
      units: 'R: Ω, ρ: Ω·m',
...

    {
      ...
      detailedExplanation: 'Resistivity সাধারণত ρ দ্বারা প্রকাশ করা হয় এবং নির্দিষ্ট temperature-এ এটি পদার্থের ধর্ম।',
      formula: 'ρ = RA/L',
      units: 'Ω·m',
...

    {
      ...
      detailedExplanation: 'Ohm’s law হলো V ∝ I, তাই V/I = constant = R।',
      formula: 'V = IR',
      units: 'V: V, I: A, R: Ω',
...

    {
      ...
      detailedExplanation: 'V বনাম I graph-এ slope R নির্দেশ করতে পারে। একই temperature-এ resistance constant থাকলে V ও I proportional।',
...

    {
      ...
      detailedExplanation: 'Series circuit-এ সব resistor-এর মধ্য দিয়ে একই current প্রবাহিত হয় এবং total voltage ভাগ হয়ে যায়।',
      formula: 'Rₛ = R₁ + R₂ + R₃ + ...',
      units: 'Ω',
...

    {
      ...
      detailedExplanation: 'Parallel connection-এ প্রতিটি resistor-এর দুই প্রান্তের potential difference একই থাকে এবং current ভাগ হয়ে যায়।',
...

    {
      ...
      detailedExplanation: 'Electrical energy W = Pt = VIt। SI unit Joule; household billing-এ kWh ব্যবহার করা হয়।',
      formula: 'W = Pt = VIt',
      units: 'জুল (J)',
...

    {
      ...
      detailedExplanation: 'Fuse wire-এর melting point তুলনামূলক কম। নির্দিষ্ট সীমার বেশি current হলে heating effect-এর কারণে fuse গলে গিয়ে circuit open করে।',
      formula: 'প্রয়োগভেদে',
...

    {
      ...
      detailedExplanation: 'Damaged insulation ব্যবহার না করা, ভেজা হাতে electrical equipment না ধরা, proper fuse/MCB ব্যবহার এবং grounding করা নিরাপত্তার গুরুত্বপূর্ণ অংশ।',
      formula: 'প্রযোজ্য নয়',
      units: 'প্রযোজ্য নয়',
