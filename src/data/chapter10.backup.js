export const chapter10 = {
  ...
  manual: [
    'তড়িৎ আধান কী এবং এর দুই ধরনের আধান বুঝতে হবে',
    'ধনাত্মক ও ঋণাত্মক আধানের বৈশিষ্ট্য জানতে হবে',
    'সমজাতীয় ও বিজাতীয় আধানের আকর্ষণ-বিকর্ষণ বুঝতে হবে',
    'আধান সংরক্ষণ সূত্র ব্যাখ্যা করতে হবে',
    'কুলম্বের সূত্র ও এর ব্যবহার জানতে হবে',
    'তড়িৎ ক্ষেত্র ও তড়িৎ ক্ষেত্রের তীব্রতা বুঝতে হবে',
    'তড়িৎ ক্ষেত্ররেখার বৈশিষ্ট্য জানতে হবে',
    'তড়িৎ বিভব ও বিভব পার্থক্যের ধারণা বুঝতে হবে',
    'তড়িৎ বিভবের সূত্র ব্যবহার করে numerical করতে হবে',
    'ধারক ও ধারকত্বের মৌলিক ধারণা জানতে হবে',
    'স্থির তড়িতের দৈনন্দিন জীবনের প্রয়োগ ও নিরাপত্তা বুঝতে হবে'
  ],
  ...
  concepts: [
    {
      ...
      detailedExplanation: 'তড়িৎ আধান দুই প্রকার—ধনাত্মক ও ঋণাত্মক। প্রোটনের আধান ধনাত্মক এবং ইলেকট্রনের আধান ঋণাত্মক।',
      formula: 'q = ne',
      units: 'কুলম্ব (C)',
...

    {
      ...
      detailedExplanation: 'ঘর্ষণের মাধ্যমে একটি বস্তু electron গ্রহণ করলে অন্য বস্তু electron হারায়। ফলে মোট charge অপরিবর্তিত থাকে।',
...

    {
      ...
      detailedExplanation: 'শূন্যস্থান বা বায়ুতে দুটি point charge-এর মধ্যে বল F = kq₁q₂/r² দ্বারা নির্ণয় করা হয়।',
      formula: 'F = kq₁q₂/r²',
      units: 'বল: নিউটন (N)',
...

    {
      ...
      detailedExplanation: 'Electric field একটি vector field। পরীক্ষণ আধানের ওপর বলের মাধ্যমে ক্ষেত্রের প্রভাব নির্ণয় করা যায়।',
      formula: 'E = F/q',
      units: 'N/C',
...

    {
      ...
      detailedExplanation: 'Electric field intensity-কে E দ্বারা প্রকাশ করা হয়। একটি point charge-এর জন্য E = kQ/r²।',
      formula: 'E = F/q = kQ/r²',
      units: 'N/C',
...

    {
      ...
      detailedExplanation: 'Field lines positive charge থেকে বের হয় এবং negative charge-এ প্রবেশ করে। দুটি field line সাধারণত পরস্পরকে ছেদ করে না।',
...

    {
      ...
      detailedExplanation: 'Electric potential একটি scalar quantity। একটি point charge-এর কারণে potential V = kQ/r।',
      formula: 'V = W/q = kQ/r',
      units: 'ভোল্ট (V)',
...

    {
      ...
      detailedExplanation: 'Potential difference-এর কারণে circuit-এ charge movement-এর জন্য driving effect সৃষ্টি হয়।',
      formula: 'V = W/q',
      units: 'ভোল্ট (V)',
...

    {
      ...
      detailedExplanation: 'সাধারণ capacitor-এ দুটি conductor-এর মধ্যে insulating medium বা dielectric থাকে।',
      formula: 'C = Q/V',
      units: 'ফ্যারাড (F)',
...

    {
      ...
      detailedExplanation: 'Capacitance C দ্বারা প্রকাশ করা হয় এবং C = Q/V।',
      formula: 'C = Q/V',
      units: 'ফ্যারাড (F)',
